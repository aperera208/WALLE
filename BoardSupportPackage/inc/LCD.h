...
void LCD_Menu_SelTop();

void LCD_Menu_SelLeft();

void LCD_Menu_SelRight();

void LCD_Menu_SelBottom();

void LCD_Menu_UnselTop();

void LCD_Menu_UnselLeft();

void LCD_Menu_UnselRight();

void LCD_Menu_UnselBottom();
 ...
 *******************************************************************************/
void LCD_DrawPicture(int16_t xStart, int16_t xEnd, int16_t yStart, int16_t yEnd, const uint16_t * Picture);
