...
packet_t get_controller_state(void)
{
    int16_t xcoord, ycoord;
    GetJoystickCoordinates(&xcoord, &ycoord);
    uint8_t top_button = GPIO_getInputPinValue(GPIO_PORT_P5, GPIO_PIN3);
    uint8_t right_button = GPIO_getInputPinValue(GPIO_PORT_P5, GPIO_PIN2);
    uint8_t bottom_button = GPIO_getInputPinValue(GPIO_PORT_P5, GPIO_PIN1);
    uint8_t left_button = GPIO_getInputPinValue(GPIO_PORT_P5, GPIO_PIN0);
