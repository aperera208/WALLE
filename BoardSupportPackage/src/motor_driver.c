...
void Motor_Update_Thresh(packet_t cont_state)
{
    ...
    //////////////     LEFT      //////////////
    else if(cont_state.yadc < 2000 && cont_state.yadc > -2000 && cont_state.xadc > 6000)                                 // Right Forward 100%
    {
        Motor_Change_Speed(0, LEFT_BW_REG);
        Motor_Change_Speed(500, RIGHT_BW_REG);
        Motor_Change_Speed(500, LEFT_FW_REG);
    ...
    else if(cont_state.yadc < 2000 && cont_state.yadc > -2000 && cont_state.xadc > 3000 && cont_state.xadc > 6000)                                 // Right Forward 66%
    {
        Motor_Change_Speed(0, LEFT_BW_REG);
        Motor_Change_Speed(400, RIGHT_BW_REG);
        Motor_Change_Speed(400, LEFT_FW_REG);
    ...
    else if(cont_state.yadc < 2000 && cont_state.yadc > -2000 && cont_state.xadc > XPOSTHRESH && cont_state.xadc < 3000)                                 // Right Forward 33%
    {
        Motor_Change_Speed(0, LEFT_BW_REG);
        Motor_Change_Speed(350, RIGHT_BW_REG);
        Motor_Change_Speed(350, LEFT_FW_REG);
    ...
    //////////////     RIGHT      //////////////
    else if(cont_state.yadc < 2000 && cont_state.yadc > -2000 && cont_state.xadc < -6000)
    {
        Motor_Change_Speed(500, LEFT_BW_REG);
        Motor_Change_Speed(0, RIGHT_BW_REG);
        Motor_Change_Speed(0, LEFT_FW_REG);
    ...
    else if(cont_state.yadc < 2000 && cont_state.yadc > -2000 && cont_state.xadc < -3000 && cont_state.xadc > -6000)
    {
        Motor_Change_Speed(400, LEFT_BW_REG);
        Motor_Change_Speed(0, RIGHT_BW_REG);
        Motor_Change_Speed(0, LEFT_FW_REG);
    ...
    else if(cont_state.yadc < 2000 && cont_state.yadc > -2000 && cont_state.xadc < XNEGTHRESH && cont_state.xadc > -3000)
    {
        Motor_Change_Speed(350, LEFT_BW_REG);
        Motor_Change_Speed(0, RIGHT_BW_REG);
        Motor_Change_Speed(0, LEFT_FW_REG);
    ...
    //////////////     TOP RIGHT      //////////////
    else if(cont_state.yadc > 6000 && cont_state.xadc > XPOSTHRESH)
    {
        Motor_Change_Speed(0, LEFT_BW_REG);
        Motor_Change_Speed(0, RIGHT_BW_REG);
    ...
    else if(cont_state.yadc > 3000 && cont_state.yadc < 6000 && cont_state.xadc > XPOSTHRESH )
    {
        Motor_Change_Speed(0, LEFT_BW_REG);
        Motor_Change_Speed(0, RIGHT_BW_REG);
        Motor_Change_Speed(325, LEFT_FW_REG);
    ...
    else if(cont_state.yadc > 2000 && cont_state.yadc < 3000 && cont_state.xadc > XPOSTHRESH )
    {
        Motor_Change_Speed(0, LEFT_BW_REG);
        Motor_Change_Speed(0, RIGHT_BW_REG);
        Motor_Change_Speed(325, LEFT_FW_REG);
    ...
    //////////////     TOP LEFT      //////////////
    else if(cont_state.yadc > 6000 && cont_state.xadc < XNEGTHRESH)
    {
        Motor_Change_Speed(0, LEFT_BW_REG);
        Motor_Change_Speed(0, RIGHT_BW_REG);
        Motor_Change_Speed(500, LEFT_FW_REG);
        Motor_Change_Speed(325, RIGHT_FW_REG);
    }
    else if(cont_state.yadc > 3000 && cont_state.yadc < 6000 && cont_state.xadc < XNEGTHRESH)
    {
        Motor_Change_Speed(0, LEFT_BW_REG);
        Motor_Change_Speed(0, RIGHT_BW_REG);
        Motor_Change_Speed(450, LEFT_FW_REG);
        Motor_Change_Speed(325, RIGHT_FW_REG);
    }
    else if(cont_state.yadc > 2000 && cont_state.yadc < 3000 && cont_state.xadc < XNEGTHRESH)
    {
        Motor_Change_Speed(0, LEFT_BW_REG);
        Motor_Change_Speed(0, RIGHT_BW_REG);
        Motor_Change_Speed(425, LEFT_FW_REG);
        Motor_Change_Speed(325, RIGHT_FW_REG);
    }
    //////////////    TOP LEFT      //////////////
    ...
    {
        Motor_Change_Speed(325, LEFT_BW_REG);
        Motor_Change_Speed(500, RIGHT_BW_REG);
        Motor_Change_Speed(0, LEFT_FW_REG);
        Motor_Change_Speed(0, RIGHT_FW_REG);
    }
    ...
    {
        Motor_Change_Speed(325, LEFT_BW_REG);
        Motor_Change_Speed(450, RIGHT_BW_REG);
        Motor_Change_Speed(0, LEFT_FW_REG);
        Motor_Change_Speed(0, RIGHT_FW_REG);
    }
    else if(cont_state.yadc < -2000 && cont_state.yadc > -3000 && cont_state.xadc > XPOSTHRESH )
    {
        Motor_Change_Speed(325, LEFT_BW_REG);
        Motor_Change_Speed(425, RIGHT_BW_REG);
        Motor_Change_Speed(0, LEFT_FW_REG);
        Motor_Change_Speed(0, RIGHT_FW_REG);
    }
    //////////////     BOTTOM RIGHT      //////////////
    ...
    {
        Motor_Change_Speed(500, LEFT_BW_REG);
        Motor_Change_Speed(325, RIGHT_BW_REG);
        Motor_Change_Speed(0, LEFT_FW_REG);
        Motor_Change_Speed(0, RIGHT_FW_REG);
    }
    else if(cont_state.yadc < -3000 && cont_state.yadc > -6000 && cont_state.xadc < XNEGTHRESH )
    {
        Motor_Change_Speed(450, LEFT_BW_REG);
        Motor_Change_Speed(325, RIGHT_BW_REG);
        Motor_Change_Speed(0, LEFT_FW_REG);
        Motor_Change_Speed(0, RIGHT_FW_REG);
    }
    ...
    {
        Motor_Change_Speed(425, LEFT_BW_REG);
        Motor_Change_Speed(325, RIGHT_BW_REG);
        Motor_Change_Speed(0, LEFT_FW_REG);
        Motor_Change_Speed(0, RIGHT_FW_REG);
    }
